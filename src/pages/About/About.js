                    ...
                    <div className="tableCellDiv">
                        ...
                        <div className="flexKoLang">
                            <div className="meDotJSON">
                                <span className="curlyBrace">&#123;</span><br/><br/>
                                    <div className="marginLeft">
                                        ...
                                        <br/><br/>
                                        <span className="position">"currentPosition" : "Software Engineer"</span>
                                        </div>
                                        &#125;<br/>
                                    </div>
